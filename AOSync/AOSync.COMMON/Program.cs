...
using MvcServiceCollectionExtensions = Microsoft.Extensions.DependencyInjection.MvcServiceCollectionExtensions;
...
public class Program
{
    ...
    private readonly List<syncExternal> _externals;
    ...
    {
        ServiceCollectionServiceExtensions.AddSingleton(services, configuration);
        services.AddDbContext<ApplicationDbContext>(options =>
            MySqlDbContextOptionsBuilderExtensions.UseMySql(options, configuration.GetConnectionString("AOSyncBetaDB"),
        ...
        ServiceCollectionServiceExtensions.AddTransient<Program>(services);
        ServiceCollectionServiceExtensions.AddTransient<ApiCommunicator>(services);
    ...
    private async Task HandleSectionComponent(syncSection section, IServiceScope scope)
    {
        ...
        if (section.Name != null) sectionEntity.Name = section.Name;
