...
namespace MAUI.ViewModels
{
    ...
    public partial class ProjectDetailViewModel : BaseViewModel
    {
        ...
        [ObservableProperty]
        private IEnumerable<SectionEntity> _sections;
        ...
        private async void OnSectionSelected(SectionEntity selectedSection)
        {
            ...
            {
                await Shell.Current.GoToAsync($"///{Routes.ProjectListView}/{Routes.ProjectDetailView}/{Routes.SectionDetailView}?SectionId={selectedSection.Id}");
            }
        }
