...
namespace MAUI.Model
{
    ...
    {
        public List<AOSync.Model.apiAttributeValue> attrs { get; set; } = new List<AOSync.Model.apiAttributeValue>();
        public List<ApiValue> fields { get; set; } = new List<ApiValue>();
    ...
    public class syncField : ComponentBase
    {
        ...
        public string? SharedField { get; set; } = null;
    ...
    public class syncFieldVal : ComponentBase
    {
        ...
        public string? Label { get; set; } = null;
        [StringLength(14, MinimumLength = 14)]
        public string? SharedFieldVal { get; set; } = null;
        public string? Tag { get; set; } = null;
    ...
    public class syncMemberProject : ComponentBase
    {
        ...
        public override string ToString()
        {
            return $"{base.ToString()}, " +
                    ...
                    $"MemberType: {MemberType?.ToString() ?? "null"}, " +
                    $"Supervisor: {Supervisor?.ToString() ?? "null"}, " +
                    $"SupervisorM: {SupervisorM?.ToString() ?? "null"}, " +
    ...
    public class syncMerged : ComponentBase
    {
        public List<AOSync.Model.apiAttributeValue> attrs { get; set; } = new List<AOSync.Model.apiAttributeValue>();
        [StringLength(14, MinimumLength = 14)]
        public string? MergedTask { get; set; } = null;
    ...
    public class syncProject : ComponentBase
    {
        public List<AOSync.Model.apiAttributeValue> attrs { get; set; } = new List<AOSync.Model.apiAttributeValue>();
        [StringLength(14, MinimumLength = 14)]
        public string? Anonymous { get; set; } = null;
        ...
        [StringLength(14, MinimumLength = 14)]
        public string? PfTypeContact { get; set; } = null;
    ...
    public class syncTask : ComponentBase
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append($", CancelDate: {CancelDate}, CancelRequestDate: {CancelRequestDate}, CancelRequestTrigger: {CancelRequestTrigger}, " +
    ...
    public class syncTeam : ComponentBase
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append($", Description: {Description}, MembersCanAddKoop: {MembersCanAddKoop}, MembersTools: {MembersTools}, " +
    ...
    public class syncUserCompany : ComponentBase
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append($", Accepted: {Accepted}, Active: {Active}, AddPfs: {AddPfs}, AddProjects: {AddProjects}, AddTeams: {AddTeams}, " +
