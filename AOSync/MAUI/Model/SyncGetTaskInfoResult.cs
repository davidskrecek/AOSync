namespace MAUI.Model
{
    internal class syncGetTaskInfoResult
    {
        ...
        {
            return $"Task Type: {taskType}, Project: {project}, Project EID: {project_eid}, Team: {team}, Team EID: {team_eid}, Group: {group}, Group EID: {group_eid}, Workspace: {workspace}, Workspace EID: {workspace_eid}, Is Error: {iserror}, Error: {error}, Is Repeatable: {isrepeatable}";
        }
    }
}
